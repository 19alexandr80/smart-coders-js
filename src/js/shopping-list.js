...
// import { dataBookShop } from './shop-list-make-markup.js'; //!!!!!!!!!!!!!!!!!!!!????
...
//   });
// }
// console.log('dataBookRender', dataBookRender); //!!!!!!!!!!!!!!!!!!!!!!!!!
// =========================================================================================

// при відкритті сторінки, викликається функція
// onOpenPage(dataBookRender); //!!!!!!!!!!!!!!!!!!!!!!!!!
// function onOpenPage(dataBookRender) {
...
//         <li class='shop-list__links amazon__dark-theme'><a href=${amazonLink} target="_blank"> <img  src='${amazon}' srcset="${amazon} 1x, ${amazon2x} 2x" rel="noopener noreferrer nofollow" aria-label="Amazon link"></a></li>
